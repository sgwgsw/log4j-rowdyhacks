...
RUN mv log4j2.xml /opt/tomcat/conf
RUN mv server.xml /opt/tomcat/conf
RUN mv setenv.sh /opt/tomcat/in
...
RUN mv tomcat-juli-8.0.53.jar /opt/tomcat/tomcat-juli.jar
...
RUN mv tomcat-extras-juli-adapters-8.0.53.jar /opt/tomcat/lib/tomcat-juli-adapters.jar
...
RUN mv apache-log4j-2.14.0-bin/log4j-api-2.14.0.jar /opt/tomcat/lib
RUN mv apache-log4j-2.14.0-bin/log4j-core-2.14.0.jar /opt/tomcat/lib
RUN mv apache-log4j-2.14.0-bin/log4j-jul-2.14.0.jar /opt/tomcat/lib
